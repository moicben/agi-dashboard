...
"[project]/pages/api/instances.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        if (Array.isArray(data)) {
            containers = data.map((instance)=>{
                ...
                if (instance.ips && Array.isArray(instance.ips) && instance.ips.length > 0) {
                    ...
                    const ipObj = instance.ips.find((ipItem)=>ipItem.address && ipItem.address.startsWith(IP_PREFIX));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__39ad551e._.js.map